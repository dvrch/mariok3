    ...
    <T.Group bind:ref={marioGroup} rotation={[0, Math.PI, 0]} {...props}>
        ...
        <T.Group position={[0, 0.6, -1.2]} scale={boostScale * 1.2}>
            <T.Mesh>
                ...
                <T.MeshStandardMaterial
                    emissive={[1, 0.6, 0.2]}
                    emissiveIntensity={isBoosting ? 4 : 1}
                    toneMapped={false}
                    transparent={true}
                    opacity={0.85}
                    depthWrite={false}
        ...
        >
            <T.Mesh>
                ...
                <T.MeshStandardMaterial
                    emissive={[1, 0.35, 0.05]}
                    emissiveIntensity={isBoosting ? 6 : 1.2}
                    transparent={true}
                    opacity={isBoosting ? 0.95 : 0.35}
        ...
        >
            <T.Mesh>
                ...
                <T.MeshStandardMaterial
                    emissive={[1, 0.25, 0.02]}
                    emissiveIntensity={isBoosting ? 5 : 0.9}
                    transparent={true}
                    opacity={isBoosting ? 0.9 : 0.3}
                    side={THREE.DoubleSide}
                    depthWrite={false}
                />
            </T.Mesh>
